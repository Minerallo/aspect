...
#ifndef _aspect_mesh_refinement_nonadiabatic_temperature_threshold_with_level_h
#define _aspect_mesh_refinement_nonadiabatic_temperature_threshold_with_level_h
...
namespace aspect
{
  namespace MeshRefinement
  {
     ...
     */
    template <int dim>
    class NonadiabaticTemperatureThresholdwithLevel : public Interface<dim>,
      public SimulatorAccess<dim>
    {
      ...
      private:
        ...
        double max_non_adiabatic_temperature_level;
